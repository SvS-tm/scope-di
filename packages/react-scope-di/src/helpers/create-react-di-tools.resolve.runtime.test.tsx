    ...
    () => 
    {
        ...
        (
            ...
            () =>
            {
                ...
                const { resolve } = createReactDiTools(scope);
                ...
                const Consumer = resolve(["Key1"], undefined, DependencyConsumer);

                expect(Consumer.displayName).toBe("DiResolve(DependencyConsumer)");
            }
        );
